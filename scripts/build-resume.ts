...
const formatProject = (proj: ProjectData): string => {
  ...
  return `    \\begin{twocolentry}{\\textbf{${escapeLatex(proj.category)}}}
...
// Main LaTeX template with narrower margins
...
\\begin{header}
    ...
    \\begin{tabularx}{\\textwidth}{@{}X r@{}}
        \\fontsize{18pt}{18pt}\\selectfont \\textbf{${escapeLatex(
          getFullName()
        )}} & 
    ...
    \\begin{tabularx}{\\textwidth}{@{}X r@{}}
        \\fontsize{9pt}{9pt}\\selectfont ${escapeLatex(info.contact.address)} & 
        \\fontsize{9pt}{9pt}\\selectfont

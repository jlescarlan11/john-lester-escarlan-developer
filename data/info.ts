  ...
  educations: [
    {
      ...
      description: [
        ...
        "Developed proficiency in multiple programming languages through hands-on projects and collaborative assignments",
  ...
  experiences: [
    {
      ...
      description: [
        "Monitor and analyze system performance across multiple applications, identifying critical issues and bottlenecks to ensure optimal system reliability.",

  ...
  return (
    <div className="relative">
      ...
      <Image
        ...
        className="w-full max-h-48 sm:max-h-80 lg:max-h-auto object-contain aspect-square grayscale scale-95 hover:grayscale-0 group-hover:grayscale-0 transition-all duration-500"
        priority
      />
    </div>
  );
